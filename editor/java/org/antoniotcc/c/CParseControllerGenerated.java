...
public class CParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("C");
  ...
  { 
    CParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = CParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = CParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(CParseControllerGenerated.class);
    }
  ...
  { 
    return CParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
